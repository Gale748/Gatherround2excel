Sub GatherRoundEnhanced()
    ...
    With aRng.Find
        ...
        .Forward = True
        Do While .Execute
            ' Ensure the range starts after the current found text to avoid infinite loop
            aRng.Start = aRng.Paragraphs(1).Range.End
            ...
            If Not aRngHead Is Nothing Then
                ...
                Else
                    ' If the heading hasn't changed, no need to repeat it
                    aRow.Cells(1).Range.Text = lastHeadingText
                End If
            Else
